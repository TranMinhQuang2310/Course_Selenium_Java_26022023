...
public class Bai28_LoginPage {
    ...
    */
    ...
    public Bai28_DashboardPage login(String email, String password) {
        //1. Open URL
        ...
        //Kiểm tra hiển thị thanh thông báo trường hợp Login không thành công
        Assert.assertTrue(verifyElementNotPresent(messageErrorEmail,3),"Login không thành công");
        return new Bai28_DashboardPage();
    }
