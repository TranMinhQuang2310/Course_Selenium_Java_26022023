...
public class Bai19_LoginPage_UseLienKetTrang {
    ...
    */
    public void verifyErrorMessageDisplay() {
        ...
        Assert.assertEquals(getTextElement(messageErrorEmail),"Invalid email or password 123","Failed . Content of the Error massage not match");
    }
    ...
    public Bai19_DashboardPage_UseLienKetTrang login(String email,String password) {
        ...
        return new Bai19_DashboardPage_UseLienKetTrang();
    }
