...
public class LoginPage_Use_DataProvider {
    ...
    */
    public void verifyErrorMessageDisplay() {
        Assert.assertTrue(DriverManager.getDriver().findElement(messageErrorEmail).isDisplayed(),"Failed . Error Message no display");
