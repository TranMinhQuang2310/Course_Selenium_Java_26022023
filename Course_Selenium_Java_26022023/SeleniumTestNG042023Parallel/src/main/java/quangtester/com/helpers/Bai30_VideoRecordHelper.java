...
//ScreenRecorder là hàm có sẵn trong java
public class Bai30_VideoRecordHelper extends ScreenRecorder {
    ...
    //Hàm xây dựng
    public Bai30_VideoRecordHelper(GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat, Format screenFormat, Format mouseFormat, Format audioFormat, File movieFolder, String name) throws IOException, AWTException {
